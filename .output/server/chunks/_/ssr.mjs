...
import { createRootRouteWithContext, Outlet, createFileRoute, lazyRouteComponent, HeadContent, Scripts as Scripts$1, RouterProvider, createRouter as createRouter$1 } from '@tanstack/react-router';
...
import { defineHandlerCallback, transformReadableStreamWithRouter, transformPipeableStreamWithRouter, attachRouterServerSsrUtils, dehydrateRouter } from '@tanstack/router-core/ssr/server';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-Dtt29b4w.mjs');
...
const $$splitComponentImporter = () => import('./index-CrQS1PDT.mjs');
...
function createRouter() {
  const CONVEX_URL = "https://descriptive-aardvark-370.convex.cloud";
