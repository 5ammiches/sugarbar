...
export function BarGenerator() {
    ...
    const shareToSocial = (platform: string) => {
        ...
        const text = `Check out this fire bar: "${currentBar.text.split('\n')[0]}" - ${currentBar.artist} 🔥`;
                ...
                <div className="text-center mb-12">
                    ...
                    <div className="bg-yellow-400 border-2 border-black p-4 max-w-3xl mx-auto shadow-shadow">
                        <p className="text-lg text-black font-mono uppercase tracking-wide font-bold">
                            &gt; DISCOVER RANDOM HIP-HOP BARS WITH SYNCHRONIZED AUDIO PLAYBACK_
                        </p>
                    </div>
                        </div>
                        ...
                        <div className="mb-8 bg-white border-2 border-black p-8 shadow-shadow">
                            ...
                            <div className="mb-6 bg-yellow-400 border-2 border-black p-4 shadow-shadow">
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                    <div>
                                        ...
                                        <p className="text-lg text-black font-mono font-bold">TRACK: "{currentBar.title}"</p>
                                        {currentBar.album && (
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="text-sm text-black font-mono uppercase font-bold">QUALITY:</div>
                            ...
                            <div className="mb-6 bg-gray-100 border-2 border-black p-4 shadow-shadow">
                                <div className="flex items-center gap-4 mb-3">
                                    ...
                                    <div className="text-sm text-black font-mono font-bold">{Math.floor(audioProgress * 0.3)}S / 30S</div>
                                </div>
                                    ...
                                    <DialogContent className="bg-white border-2 border-black shadow-shadow">
                                        ...
                                        <div className="space-y-4">
                                            <div className="grid grid-cols-2 gap-3">
                                                ...
                                                <Button onClick={copyToClipboard} className="bg-gray-700 text-white border-2 border-black shadow-[4px_4px_0px_0px_#000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none">
